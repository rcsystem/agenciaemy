...
<!-- Custom css --> 
		...
		<!--iconos online https://fontawesome.com/get-started-->
...
<div class="main">
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<a href="#"><center><img src="<?php echo base_url();?>assets/images/logo1 (2).png"  alt=""></center></a>				
				</li>
                <li>
				<a href="#">Inicio</a>
	...
	<div class="row">
					...
					<div class="home-contacto col-lg-5">
					<form>
					<div class="form-row align-items-center" style="padding:18px 0px;">
						...
						<div class="col-auto">
							<button type="submit" class="home-btn-login">Entrar</button>
